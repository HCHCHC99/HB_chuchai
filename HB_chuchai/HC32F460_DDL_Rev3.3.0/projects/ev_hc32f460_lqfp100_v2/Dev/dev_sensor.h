...
// ========== 电流传感器硬件参数 ==========
    ...
    // ===== 差分运放模式参数 (LM358 IBUS电路) =====
    // 输出特性: Vout = I * 0.1, 即 100mV/A
